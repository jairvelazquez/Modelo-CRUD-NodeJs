...
--
-- Host: 127.0.0.1    Database: cinecut2
-- ------------------------------------------------------
...
INSERT INTO `actor` (`id_personalidad`, `origen`, `arquetipo`) VALUES (21,'Cine','Villano'),(22,'Television','Personaje de apoyo'),(23,'Modelaje','Romantico'),(24,'Modelaje','Loco'),(25,'Telvision','Personaje de apoyo'),(26,'Stand Ups','Comico'),(27,'Streaming','Nerd'),(29,'Cine','Temeroso'),(30,'Peliculas B','Villano'),(33,'Fight Club','Prota atractivo');
...
INSERT INTO `guionista` (`id_personalidad`, `guion_reconocido`, `genero`) VALUES (1,'Avatar','Ciencia Ficción'),(2,'La la Land','Musicales'),(4,'Scarface','Acción'),(5,'Pineapple Express','Comedia'),(6,'500 Days of Summer','Romantica'),(7,'Alien','Ciencia Ficción, Suspenso'),(8,'Superbad','Comedia'),(9,'Alita','Ciencia Ficción, Acción'),(10,'Coraline','Animada'),(31,'Eternal sunshine','Drama');
...
INSERT INTO `participa` (`id_personalidad`, `id_pelicula`, `rol`) VALUES (1,1,'Guionista'),(2,2,'Guionista'),(4,4,'Guionista'),(5,5,'Guionista'),(6,6,'Guionista'),(7,7,'Guionista'),(8,8,'Guionista'),(9,9,'Guionista'),(10,10,'Guionista'),(10,11,'Guionista'),(9,12,'Guionista'),(7,14,'Guionista'),(6,15,'Guionista'),(11,1,'Director'),(12,2,'Director'),(13,3,'Director'),(14,4,'Director'),(15,5,'Director'),(16,6,'Director'),(17,7,'Director'),(18,8,'Director'),(19,9,'Director'),(20,10,'Director'),(20,11,'Director'),(19,12,'Director'),(17,14,'Director'),(16,15,'Director'),(21,1,'Actor'),(22,2,'Actor'),(23,3,'Actor'),(24,4,'Actor'),(25,5,'Actor'),(26,6,'Actor'),(27,7,'Actor'),(29,9,'Actor'),(30,10,'Actor'),(30,11,'Actor'),(29,12,'Actor'),(27,14,'Actor'),(26,15,'Actor'),(1,1,'Guionista');
...
INSERT INTO `personalidad` (`id`, `nombre`, `apellidos`, `sexo`, `edad`, `fecha_nacimiento`) VALUES (1,'Josiah','Josiaaaaaaaa','2',NULL,'1997-04-14'),(2,'Denton','Rice','1',NULL,'2003-05-21'),(4,'Avye','Austin','1',NULL,'1987-04-17'),(5,'Keane','Henry','1',NULL,'1996-02-28'),(6,'Aubrey','Hutchinson','2',NULL,'2065-11-15'),(7,'Ethan','Morse','1',NULL,'1977-03-14'),(8,'Urielle','West','2',NULL,'2000-02-17'),(9,'Christine','Green','1',NULL,'1988-08-31'),(10,'Rebekah','Thornton','1',NULL,'1999-11-02'),(11,'Beau','Mccullough','2',NULL,'2002-02-02'),(12,'Magee','Prince','1',NULL,'1993-07-14'),(13,'Grace','Kelly','1',NULL,'1978-01-12'),(14,'Kirk','Francis','1',NULL,'1995-09-09'),(15,'Octavia','Vinson','2',NULL,'1994-08-10'),(16,'Allen','Hester','2',NULL,'2044-05-18'),(17,'Sacha','Macias','2',NULL,'1986-07-15'),(18,'Kadeem','Jones','2',NULL,'1972-01-28'),(19,'John','Forbes','1',NULL,'1992-09-08'),(20,'Cruz','Hull','2',NULL,'1984-02-14'),(21,'Nichole','Knight','2',NULL,'1997-09-09'),(22,'Ila','Frederick','2',NULL,'1988-02-27'),(23,'Kelly','Howard','2',NULL,'1998-04-14'),(24,'Ross','Montoya','1',NULL,'1977-12-25'),(25,'Burke','Avery','2',NULL,'1984-02-27'),(26,'Holmes','Thompson','1',NULL,'1976-07-22'),(27,'Charissa','Clements','2',NULL,'2005-05-05'),(29,'Lenore','Heath','1',NULL,'1993-02-22'),(30,'Bree','Trujillo','2',NULL,'2044-10-31'),(31,'Charlie','Kauffman','1',NULL,'1998-05-25'),(32,'Christopher','Nolan','1',NULL,'2002-05-05'),(33,'Brad','Pitt','1',NULL,'2002-05-04');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `edad_BI_personalidad_update_trigger` BEFORE UPDATE ON `personalidad` FOR EACH ROW BEGIN
    declare age int;
...
INSERT INTO `puntua_estable` (`id_pelicula`, `id_usuario`, `calificacion`) VALUES (1,6,6),(2,7,8),(3,8,10),(5,10,3),(15,11,8),(12,12,10),(14,14,2),(7,16,9),(8,17,4),(9,18,6),(10,19,1),(11,20,7),(1,1,7),(2,1,7),(3,1,7),(4,1,7),(5,1,7),(6,1,7),(1,2,25),(1,2,24);
...
--
-- Dumping events for database 'cinecut2'
--

--
-- Dumping routines for database 'cinecut2'
--
...
-- Dump completed on 2020-05-29 11:39:43
